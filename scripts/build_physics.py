...
def _gennaker(sp, forestay_stem_mm, mast_top_mm):
    ...
    return {
        ...
        # выбрал — угол пришёл к ДП, потравил — ушёл наружу. Пределы взяты по
        # геометрии: короче прямой от обуха до галса парус не выбрать никаким
        # усилием, длиннее — он уже не держится вовсе.
        "sheet_min_m": round(math.hypot(lead[0] - tk[0], lead[1]) * 1.0, 3),
