...
def main():
    ...
    # `rev` — номер коммита по порядку, а не хэш. Хэш отвечает на вопрос «какой
    # именно код», порядковый номер — на вопрос «свежее ли того, что я видел
    # минуту назад», и на экране нужен именно второй: глазом с телефона хэши не
    # сравнить, а «r742 против r741» читается сразу.
