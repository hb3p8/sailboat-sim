...
//
// Гейн ×3 приводит типичный порыв к тем самым восемнадцати процентам. Число не
// выдумано здесь: ровно с таким гейном поле уже входит в покраску воды строкой
// ниже, и берётся оно теперь одной постоянной на оба проявления НАРОЧНО. Где
// темнее, там и шершавее, и ровно во столько же — иначе язык порыва
// расслаивается на тёмное пятно и отдельно от него взъерошенную воду.
