...
function updateCrew() {
  ...
  // Борт — противоположный парусу, тем же выражением, каким парус и рисуется.
  // Так они не разойдутся никогда: экипаж на наветренном борту по определению
  // есть «не там, где парус». Знак плеча дал бы то же самое, но на ровном киле
  // он вырождается в ноль, и фигурки принимались бы прыгать с борта на борт.
