...
export class Boat {
  ...
  constructor(pack, terrain, opts) {
    ...
    this.o = Object.assign({
      ...
      freeWake: false,
      // Пелена ВХОДИТ В СИЛЫ. Пока за выключателем: она заменяет прямые лучи
      // решётки, а это самая рискованная правка во всей части III — она двигает
      // силы и требует пересбора эталона. Включённая, она сама поднимает
      // freeWake: без сошедшей пелены парус остался бы вовсе без своего следа.
      wakeForces: false,
