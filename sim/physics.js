...
export class Boat {
  ...
  buildStrips() {
    ...
    const sails = [
      ...
      //
      // Без этого стаксель на полном курсе разворачивался на все семьдесят с
      // лишним градусов вместе с гротом. Хорда у него длинная и начинается
      // далеко в носу, поэтому шкотовый угол уезжал вбок дальше гика — на
      // картинке выходил парус, вынесенный спинакер-гиком, чего на одних
      // шкотах не бывает.
