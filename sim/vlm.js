...
export class FreeWake {
  ...
  // Полубесконечные хвосты. Выделены отдельно, чтобы ветка с кернелом и ветка
  // без него звали ОДИН И ТОТ ЖЕ код: разойтись здесь значило бы получить два
  // разных поля при одинаковом на вид переключателе.
