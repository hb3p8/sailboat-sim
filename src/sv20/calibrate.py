...
# Серийная SV20 (shop.silavetra.com) отличается от проекта 2010 года: лодка
# потяжелела. Обводы снимаются с чертежа, а гидростатика сводится к серийной
# машине — той, поведение которой можно проверить на воде.
TARGET = {
    "displacement_kg": 590.0,
    "draft_max_mm": 1550.0,
    "sail_area_upwind_m2": 25.0,
    "sail_area_downwind_m2": 56.0,
    "ballast_kg": 250.0,
    "source": "shop.silavetra.com, серийная SV20",
}
